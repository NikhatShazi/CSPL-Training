...
namespace eGift.WebAPI.Models.DataModels
{
    ...
    public class ProductModel : BaseModel
    {
        ...
        [Column("PictureData1", TypeName = "varbinary(MAX)")]
        public byte[] PictureData1 { get; set; }

        [Column("PictureData2", TypeName = "varbinary(MAX)")]
        public byte[] PictureData2 { get; set; }

        [Column("PictureData3", TypeName = "varbinary(MAX)")]
        public byte[] PictureData3 { get; set; }

        [Column("PictureData4", TypeName = "varbinary(MAX)")]
        public byte[] PictureData4 { get; set; }

        [Column("ProductImagePath", TypeName = "varchar(500)")]
        public string ProductImagePath { get; set; }

        [Column("ProductImageData", TypeName = "varbinary(MAX)")]
